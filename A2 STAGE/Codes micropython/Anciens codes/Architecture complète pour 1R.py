...
def etalonnage(ETLN, nb_etalonnages) :
    #CHANGER ET FAIRE EN SORTE QU'IL N'Y AIT PAS D'ETALONNAGE QUAND L'ADC EST FONCTIONNEL
    if ETLN > 1000 :
...
OVERSAMPLE = setup(resolution = 0x3, oversample = 0, freq_echantillonnage = 0x0, burst = False) 
