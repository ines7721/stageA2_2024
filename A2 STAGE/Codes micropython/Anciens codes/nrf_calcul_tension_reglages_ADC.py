...
def setup(resolution, freq_echantillonnage, ETLN) :
    mem32[BASE_ADDR_ADC + 0x300] = 0x1F
    inten = mem32[BASE_ADDR_ADC + 0x300] 
    print(inten) 
    
    mem32[BASE_ADDR_ADC + 0x304] = 0x1F
...
ETLN = 2000
#fréquence d'échantillonnage / bit 12 : 0 pour caler sur event SAMPLE, 1 pour définir une valeur;
#bits 0-10 : valeur CC, binaire entre 80 et 2047 avec f_echantillonnage = 16MHz / CC

setup(resolution = 0x3, freq_echantillonnage = 0x1080, ETLN = 2000) 
